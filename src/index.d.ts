declare module "@jstarpl/react-contextmenu" {
  ...
  export const ContextMenu: React.ComponentClass<
    React.PropsWithChildren<ContextMenuProps>
  >;
  export const ContextMenuTrigger: React.ComponentClass<
    React.PropsWithChildren<ContextMenuTriggerProps>
  >;
  export const MenuItem: React.ComponentClass<
